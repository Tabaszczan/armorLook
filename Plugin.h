...
namespace GOTHIC_ENGINE {
	#define PLUGIN_NAME "ARMORCHANGE"
	#define OPTION_ARMOR_NAME (A zoptions->ReadString(PLUGIN_NAME, "ArmorName", ""))
	#define OPTION_ARMOR_CHANGED  zoptions->ReadInt(PLUGIN_NAME, "ArmorChanged", 0)
	#define OPTION_ARMOR_NUMBER  zoptions->ReadInt(PLUGIN_NAME, "ArmorChangedNumber", 0)
	#define OPTION_OPEN_BUTTON (A zoptions->ReadString(PLUGIN_NAME, "ArmorMenuOpenKey", "KEY_HOME"))
